...
void autonomous() {
    ...
    // Get 1 blue block
    chassis.swingToPoint(10, -29, lemlib::DriveSide::RIGHT, 800, {.forwards = false, .minSpeed = 10});
    chassis.moveToPoint(10, -29, 1200, {.forwards = false, .maxSpeed = 80});
    ...
    chassis.moveToPoint(50, -1, 200, {.maxSpeed = 50});
