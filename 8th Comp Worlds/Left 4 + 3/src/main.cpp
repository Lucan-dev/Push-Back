...
void autonomous() {
    ...
    // Score long goal
    chassis.turnToPoint(-31, 16, 800, {.minSpeed = 10, .earlyExitRange = 4});
    chassis.moveToPoint(-31, 16, 1000, {.minSpeed = 10, .earlyExitRange = 2});

    chassis.turnToPoint(-28.5, 30, 800, {.forwards = false, .minSpeed = 10, .earlyExitRange = 2});
    chassis.moveToPoint(-28.5, 30, 800, {.forwards = false, .minSpeed = 30});

    pros::delay(500);
    piston_long();

    chassis.turnToHeading(195, 300, {.minSpeed = 30});
    chassis.moveToPoint(-28.5, 30, 300, {.forwards = false, .minSpeed = 100});
